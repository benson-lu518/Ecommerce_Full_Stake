...
import static com.bensonlu.ecommercefullstack.domain.OrderAsserts.*;
import static com.bensonlu.ecommercefullstack.web.rest.TestUtil.createUpdateProxyForBean;
import static com.bensonlu.ecommercefullstack.web.rest.TestUtil.sameNumber;
...
import com.bensonlu.ecommercefullstack.repository.UserRepository;
...
class OrderResourceIT {
    ...
    public static Order createEntity() {
        return new Order().totalAmount(DEFAULT_TOTAL_AMOUNT).createdDate(DEFAULT_CREATED_DATE).lastModifiedDate(DEFAULT_LAST_MODIFIED_DATE);
    }
    ...
    public static Order createUpdatedEntity() {
        return new Order().totalAmount(UPDATED_TOTAL_AMOUNT).createdDate(UPDATED_CREATED_DATE).lastModifiedDate(UPDATED_LAST_MODIFIED_DATE);
    }
    ...
    void createOrder() throws Exception {
        ...
        var returnedOrder = om.readValue(
            restOrderMockMvc
                .perform(post(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(order)))
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.totalAmount(UPDATED_TOTAL_AMOUNT).createdDate(UPDATED_CREATED_DATE).lastModifiedDate(UPDATED_LAST_MODIFIED_DATE);
    ...
    void putWithMissingIdPathParamOrder() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restOrderMockMvc
            .perform(put(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(order)))
    ...
    void patchWithMissingIdPathParamOrder() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restOrderMockMvc
            .perform(patch(ENTITY_API_URL).with(csrf()).contentType("application/merge-patch+json").content(om.writeValueAsBytes(order)))
            .andExpect(status().isMethodNotAllowed());
