...
export const ProductDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ecommercefullstackApp.product.delete.question">
        <Translate contentKey="ecommercefullstackApp.product.delete.question" interpolate={{ id: productEntity.id }}>
