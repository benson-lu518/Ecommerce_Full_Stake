...
export const OrderItemDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ecommercefullstackApp.orderItem.delete.question">
        <Translate contentKey="ecommercefullstackApp.orderItem.delete.question" interpolate={{ id: orderItemEntity.id }}>
