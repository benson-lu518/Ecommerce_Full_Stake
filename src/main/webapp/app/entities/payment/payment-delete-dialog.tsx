...
export const PaymentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ecommercefullstackApp.payment.delete.question">
        <Translate contentKey="ecommercefullstackApp.payment.delete.question" interpolate={{ id: paymentEntity.id }}>
