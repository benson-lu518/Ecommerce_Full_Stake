...
export const OrderDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ecommercefullstackApp.order.delete.question">
        <Translate contentKey="ecommercefullstackApp.order.delete.question" interpolate={{ id: orderEntity.id }}>
