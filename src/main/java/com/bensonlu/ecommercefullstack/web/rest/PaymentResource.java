...
/**
 * REST controller for managing {@link com.bensonlu.ecommercefullstack.domain.Payment}.
 */

// Todo: future work: add payment feature
        ...
        Optional<Payment> result = paymentRepository
            ...
            .map(existingPayment -> {
                if (payment.getPaymentState() != null) {
                    existingPayment.setPaymentState(payment.getPaymentState());
                }
