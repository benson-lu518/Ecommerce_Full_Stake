...
/**
 * REST controller for managing {@link com.bensonlu.ecommercefullstack.domain.OrderItem}.
 */
@RestController
...
public class OrderItemResource {
        ...
        Optional<OrderItem> result = orderItemRepository
            ...
            .map(existingOrderItem -> {
                ...
                if (orderItem.getAmount() != null) {
                    existingOrderItem.setAmount(orderItem.getAmount());
                }
                if (orderItem.getCreatedDate() != null) {
                    existingOrderItem.setCreatedDate(orderItem.getCreatedDate());
                }
                if (orderItem.getLastModifiedDate() != null) {
                    existingOrderItem.setLastModifiedDate(orderItem.getLastModifiedDate());
                }
    ...
    public ResponseEntity<List<OrderItem>> getAllOrderItems(
        ...
        Page<OrderItem> page;
        if (eagerload) {
            page = orderItemRepository.findAllWithEagerRelationships(pageable);
        } else {
            page = orderItemRepository.findAll(pageable);
        }
